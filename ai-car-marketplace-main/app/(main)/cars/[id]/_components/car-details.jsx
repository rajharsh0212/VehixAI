...
export function CarDetails({ car, testDriveInfo }) {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator
        .share({
          title: `Check out this ${car.year} ${car.make} ${car.model}`,
          text: `Check out this ${car.year} ${car.make} ${car.model} on VehixAI!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog open={isEmiCalculatorOpen} onOpenChange={setIsEmiCalculatorOpen}>
            ...
            <DialogContent>
              <DialogTitle>VehixAI Car Loan Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Have questions?{" "}
                <a href="mailto:help@vehixai.in" className="text-blue-500 underline">
